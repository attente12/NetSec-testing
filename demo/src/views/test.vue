...
<!--        </el-button>-->
<!--      </div>-->
<!--&lt;!&ndash;      <el-button type="primary" icon="el-icon-printer" @click="exportPdf" :loading="pdfExporting">&ndash;&gt;-->
<!--&lt;!&ndash;        导出PDF报告&ndash;&gt;-->
...
<!--          &lt;!&ndash;            <span class="label">空闲内存：</span>&ndash;&gt;-->
<!--          &lt;!&ndash;            <span class="value">{{ currentAsset.serverinfo.free }}</span>&ndash;&gt;-->
<!--          &lt;!&ndash;          </div>&ndash;&gt;-->
<!--          &lt;!&ndash;          <div class="info-item" v-if="currentAsset.serverinfo">&ndash;&gt;-->
...
<!--                &lt;!&ndash;                <span class="score-number-small">{{ currentAsset.M }}</span>&ndash;&gt;-->
...
<!--                    &lt;!&ndash;                    <el-table-column prop="important_level" label="重要级别" width="100">&ndash;&gt;-->
<!--                    &lt;!&ndash;                      <template slot-scope="scope">&ndash;&gt;-->
<!--                    &lt;!&ndash;                        <el-tag :type="getLevel3ImportanceLevelType(scope.row.important_level)">&ndash;&gt;-->
<!--                    &lt;!&ndash;                          {{ getLevel3ImportanceLevel(scope.row.important_level) }}&ndash;&gt;-->
<!--                    &lt;!&ndash;                        </el-tag>&ndash;&gt;-->

    ...
    <el-card class="box-card">
      ...
      <el-form @submit.prevent="submitForm" :model="formData" :rules="rules" ref="form" label-width="120px"
        ...
        <el-form-item label="测评级别" prop="level">
          <el-select v-model="formData.level" placeholder="请选择测评级别" style="width: 100%">
            <el-option label="三级等保" :value="3">
            </el-option>
            <el-option label="二级等保" :value="2" disabled>
            </el-option>
            <el-option label="一级等保" :value="1" disabled>
            </el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="IP 地址" prop="ip">
          <el-select v-model="formData.ip" placeholder="请选择或输入服务器IP地址" filterable allow-create default-first-option
            style="width: 100%">

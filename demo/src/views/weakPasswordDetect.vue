    ...
    async serviceDetect() {
      ...
      try {
        ...
        const serviceRequests = this.selectedServices.map(serviceName => {
          ...
          return axios.post('/api/getWeakPassword', formData, {
            headers: {
...
<!--&lt;!&ndash;                placeholder="选择扫描目标IP"&ndash;&gt;-->
<!--&lt;!&ndash;                filterable&ndash;&gt;-->
<!--&lt;!&ndash;                allow-create&ndash;&gt;-->
...
<!--&lt;!&ndash;                @click="clearLocalStorage">&ndash;&gt;-->
<!--&lt;!&ndash;              清除数据&ndash;&gt;-->
<!--&lt;!&ndash;            </el-button>&ndash;&gt;-->
<!--          </div>-->
<!--        </div>-->

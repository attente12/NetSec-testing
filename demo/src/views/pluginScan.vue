...
// 修改 sortedVulnResults 计算属性
  ...
  methods: {
    ...
    autoSelect() {
      ...
      axios.post('/api/pocScan/autoSelectPoc', { ip: this.scanTarget })
          .then(response => {
...
#printable {
  ...
  top: -9999px; /* 移出可视区域 */
  left: -9999px;
  visibility: hidden; /* 添加visibility属性进一步隐藏 */
  z-index: -1000; /* 确保在最底层 */
  opacity: 0; /* 完全透明 */
...
#printable .print-info p {
  margin: 15px 0;   /* 增加行间距 */
  font-size: 30px;  /* 确保内部段落也有正确的字体大小 */
}
...
<!--          </div>-->
<!--          <div class="scan-button" style="margin-bottom: 60px;">-->
<!--            &lt;!&ndash;            <el-button size="small" @click="chooseDetect">扫描</el-button>&ndash;&gt;-->
<!--            <el-button-->
<!--                size="small"-->
<!--                @click="chooseDetect"-->
<!--                :loading="detectState"-->
...
<!--            </div>-->
<!--            <div class="scan-button">-->
<!--              &lt;!&ndash;              <el-button size="small" @click="runPoc">执行poc</el-button>&ndash;&gt;-->
<!--              <el-button-->
<!--                  size="small"-->
<!--                  @click="runPoc"-->
<!--                  :loading="runPocState"-->
...
<!--          <div slot="header" class="clearfix">-->
<!--            <span>扫描结果</span>-->
<!--&lt;!&ndash;            <div style="float: right" v-if="result.scan_time">检测时间: {{ result.scan_time }}</div>&ndash;&gt;-->
<!--&lt;!&ndash;            <div style="float: right" v-if="time">检测时间: {{ time }}</div>&ndash;&gt;-->
<!--          </div>-->
<!--          <el-button-->
<!--              @click="printReport"-->
<!--              :loading="printLoading"-->
...
<!--&lt;!&ndash;              :data="sortedVulnResults"&ndash;&gt;-->
<!--&lt;!&ndash;              style="width: 100%"&ndash;&gt;-->
<!--&lt;!&ndash;              :default-sort = "{prop: 'vulExist', order: 'descending'}"&ndash;&gt;-->
<!--&lt;!&ndash;              v-if="result.ports"&ndash;&gt;-->
<!--&lt;!&ndash;          >&ndash;&gt;-->
<!--&lt;!&ndash;            <el-table-column prop="Vuln_id" label="漏洞ID" width="150"></el-table-column>&ndash;&gt;-->
<!--&lt;!&ndash;            <el-table-column prop="vul_name" label="漏洞名称" width="200"></el-table-column>&ndash;&gt;-->
<!--&lt;!&ndash;            <el-table-column prop="CVSS" label="CVSS" width="100"></el-table-column>&ndash;&gt;-->
<!--&lt;!&ndash;            <el-table-column prop="pocExist" label="POC存在" width="100">&ndash;&gt;-->
<!--&lt;!&ndash;              <template slot-scope="scope">&ndash;&gt;-->
<!--&lt;!&ndash;                {{ scope.row.pocExist ? '是' : '否' }}&ndash;&gt;-->
<!--&lt;!&ndash;              </template>&ndash;&gt;-->
<!--&lt;!&ndash;            </el-table-column>&ndash;&gt;-->
<!--&lt;!&ndash;            <el-table-column prop="ifCheck" label="是否检查" width="100">&ndash;&gt;-->
<!--&lt;!&ndash;              <template slot-scope="scope">&ndash;&gt;-->
<!--&lt;!&ndash;                {{ scope.row.ifCheck ? '是' : '否' }}&ndash;&gt;-->
<!--&lt;!&ndash;              </template>&ndash;&gt;-->
<!--&lt;!&ndash;            </el-table-column>&ndash;&gt;-->
<!--&lt;!&ndash;            <el-table-column&ndash;&gt;-->
<!--&lt;!&ndash;                prop="vulExist"&ndash;&gt;-->
<!--&lt;!&ndash;                label="漏洞状态"&ndash;&gt;-->
<!--&lt;!&ndash;                width="100"&ndash;&gt;-->
<!--&lt;!&ndash;                :filters="[&ndash;&gt;-->
<!--&lt;!&ndash;                { text: '存在', value: '存在' },&ndash;&gt;-->
<!--&lt;!&ndash;                { text: '不存在', value: '不存在' },&ndash;&gt;-->
<!--&lt;!&ndash;                { text: '未验证', value: '未验证' }&ndash;&gt;-->
<!--&lt;!&ndash;              ]"&ndash;&gt;-->
<!--&lt;!&ndash;                :filter-method="filterVulExist"&ndash;&gt;-->
<!--&lt;!&ndash;            >&ndash;&gt;-->
<!--&lt;!&ndash;              <template slot-scope="scope">&ndash;&gt;-->
<!--&lt;!&ndash;                <el-tag :type="scope.row.vulExist === '存在' ? 'danger' : 'info'">&ndash;&gt;-->
<!--&lt;!&ndash;                  {{ scope.row.vulExist }}&ndash;&gt;-->
<!--&lt;!&ndash;                </el-tag>&ndash;&gt;-->
<!--&lt;!&ndash;              </template>&ndash;&gt;-->
<!--&lt;!&ndash;            </el-table-column>&ndash;&gt;-->
<!--&lt;!&ndash;            <el-table-column prop="summary" label="描述"></el-table-column>&ndash;&gt;-->
<!--&lt;!&ndash;          </el-table>&ndash;&gt;-->
<!--          <el-table-->
<!--              :data="sortedVulnResults"-->
<!--              style="width: 100%"-->
...
<!--          <p><strong>操作系统：</strong>{{ result.os_list ? result.os_list.join(', ') : '未知' }}</p>-->
<!--          <p><strong>系统版本：</strong>{{ result.os_matches ? result.os_matches.join(', ') : '未知' }}</p>-->
<!--&lt;!&ndash;          <p><strong>扫描时间：</strong>{{ result.scan_time }}</p>&ndash;&gt;-->
<!--        </div>-->
<!--      </div>-->
...
<!--            <th>漏洞名称</th>-->
<!--            <th>CVSS</th>-->
<!--&lt;!&ndash;            <th>POC存在</th>&ndash;&gt;-->
<!--&lt;!&ndash;            <th>是否检查</th>&ndash;&gt;-->
<!--            <th>漏洞状态</th>-->
<!--            <th>描述</th>-->
<!--            <th>检测时间</th>-->
<!--          </tr>-->
...
<!--&lt;!&ndash;            <td>{{ vuln.ifCheck ? '是' : '否' }}</td>&ndash;&gt;-->
<!--            <td>{{ vuln.vulExist }}</td>-->
<!--            <td>{{ vuln.summary }}</td>-->
<!--            <td>{{ vuln.scan_time }}</td>-->
<!--          </tr>-->
...
<!--&lt;!&ndash;              rows="2"&ndash;&gt;-->
<!--&lt;!&ndash;              placeholder="扫描的目标，例如：192.168.1.0"&ndash;&gt;-->
<!--&lt;!&ndash;              v-model="scanTarget"&ndash;&gt;-->
<!--&lt;!&ndash;              @input="validateInput">&ndash;&gt;-->
<!--&lt;!&ndash;          </el-input>&ndash;&gt;-->
<!--&lt;!&ndash;          <div style="margin-bottom: 10px; color: #E6A23C; font-size: 13px;">&ndash;&gt;-->
<!--&lt;!&ndash;            <i class="el-icon-warning-outline" style="margin-right: 5px;"></i>如果该资产未进行过端口扫描，需要进行预扫描。&ndash;&gt;-->
<!--&lt;!&ndash;          </div>&ndash;&gt;-->
<!--          <div style="margin-bottom: 10px; color: #409EFF; font-size: 13px;">-->
<!--            <i class="el-icon-warning-outline" style="margin-right: 5px;"></i>如果该资产未进行过端口扫描，需要进行预扫描。-->
<!--          </div>-->

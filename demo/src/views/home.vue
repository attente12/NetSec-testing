    ...
    <div class="platform-intro">
      <el-card shadow="hover" class="intro-card">
        ...
        <div class="intro-content">
          <p>
            在数字化时代，网络安全风险无处不在。我们的<strong>网络安全测试平台</strong>，集<strong>资产清点、安全基线检测、弱口令检测、安全风险评估、安全等级保护测评、测试报告输出</strong>于一体，旨在为企业提供全方位、智能化的安全检测服务，助力提升网络安全防护能力。
          </p>
    ...
    <div class="features-section">
      ...
      <div class="features-grid">
        <div class="feature-card" v-for="(feature, index) in features" :key="index"
          @click="navigateToFeature(feature.path)" :style="{ animationDelay: index * 0.1 + 's' }">
          <el-card shadow="hover" :body-style="{ padding: '0px' }">
            <div class="feature-icon"
              :style="{ background: feature.gradient || 'linear-gradient(135deg, #409EFF, #67C23A)' }">
          ...
          <div class="manual-items">
            ...
            <div class="manual-item">
              ...
              <div class="manual-item-content">
                ...
                <el-button type="primary" size="small" icon="el-icon-download"
                  @click="downloadFile('/CVE-Search_helper.pdf')">
                  下载手册
                </el-button>
              </div>
            </div>
            ...
            <div class="manual-item">
              ...
              <div class="manual-item-content">
                ...
                <el-button type="primary" size="small" icon="el-icon-download"
                  @click="downloadFile('/level3_protection_description.pdf')">
                  下载手册
                </el-button>
              </div>
            </div>
